...
#names = pd.read_csv('../../websiteparsers/searchtruth.com/muslimNames.csv')
# print (names)
...
#print ("Name: %s, features=%s, religion=%s" % (names[0][0], X[0], y[0]))
...
print (clf.predict(vectorizer.transform(features([sys.argv[1]]))))
